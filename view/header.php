...
<head>
    ...
    <link rel="stylesheet" href="css/delicada.css">
...
<header>    
    <div class="header-black">
        <div class="container">
            <div class="row">
                <nav id="topo" class="pull-right">
                    <ul>
                        <li><a href="#"><i class="fa fa-user"></i> Cadastre-se</a></li>
                        <li><a href="#"><i class="fa fa-sign-in"></i> Faça seu login</a></li>
                        <li><a href="#"><i class="fa fa-comment"></i> Fale Conosco</a></li>
                        <li><a href="#"><i class="fa fa-info-circle" data-toggle="modal" data-target="#janela"></i></a></li>
        ...
        <div class="row">
            <nav id="menu" class="pull-right">
                <ul>
                    ...
                    <li><a href="shop.php"><i id="bag" class="fa fa-shopping-bag"></i></a></li>
                </ul>
